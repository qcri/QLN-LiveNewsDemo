   ...
   <body>
      <nav class="navbar navbar-dark bg-dark justify-content-between">
	    ...
	    <form class="form-inline">
            ...
            <a class="btn btn-default my-2 my-sm-0" target="_blank" href="../index.php">AR &nbsp;
            <span style="float:right;">
		...
		<a class="btn btn-default my-2 my-sm-0" target="_blank" href="embed_python.php">Map &nbsp;
            <span style="float:right;">
               ...
               <div id="menu1" class="tab-pane fade msize">
                  ...
                  <form id="form4" action="<?=$_SERVER['PHP_SELF'];?>" method="POST" >
                     ...
                     <?php 
                        ...
                        echo '<p class=\'desc\'>Sources: '.mysqli_num_rows($result1).'</p>';                         
