...

    {
...

        {
            ...
            {           
                ...
                echo "<td width='140px' align='center' style='padding: 5px 10px 5px 5px;'><span id='".$tweetid."c' name='".$tweetid."c'  title=\"Centrality\">&nbsp;<script>drawCerntalityChart($biasscores[0],$biasscores[1],$biasscores[2],$biasscores[3],$biasscores[4],$biasscores[5],$biasscores[6],'".$tweetid."c');</script></span><br>Centrality</td>";
